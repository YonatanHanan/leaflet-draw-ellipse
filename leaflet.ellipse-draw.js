...
(function(window, document, undefined) {
  ...
  L.Edit.Ellipse = L.Edit.SimpleShape.extend({
    ...
    _radians_to_degrees: function(radians) {
      var pi = Math.PI;
      return radians * (180 / pi);
    },

    _angleBetweenPoints: function(a, b) {
      let deltaY = Math.abs(b.y - a.y);
      let deltaX = Math.abs(b.x - a.x);
      return this._radians_to_degrees(Math.atan2(deltaY, deltaX));
    },
    ...
    _rotate: function(latlng) {
      ...
      let tilt = this._angleBetweenPoints(movePoint, point);
